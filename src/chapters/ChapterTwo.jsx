  ...
  return (
    <div className="chapter-two">
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-12 col-md-6 pl-lg-5">
            ...
            <Image src={ChapterTwoImg2} alt="Chapitre 2" className="img-fluid" y={["200px", "-200px"]} figcaption="Avant, Nicolas (dit PQ) vagabondait de ville en ville et jouait au BikePolo. Il a trouvé l’Alsace et la capitale européenne comme terre d’accueil."/>
          </div>
        </div>
      </div>
      <Spacer size="medium"/>
      ...
      <div className="container">
        <div className="row">
          <div className="col-12 col-md-6 pr-lg-5">
            <Image src={ChapterTwoImg3} alt="Chapitre 2" className="img-fluid" y={["200px", "-200px"]} figcaption="La joyeuse troupe de Strasbourg Bike Polo prend la pose pour une photo de groupe. Convivialité déjantée et inclusion sont les maîtres-mots de la discipline selon eux."/>
          ...
          <div className="col-12 col-md-6 pl-lg-5">
            ...
            <figure className="team-logos">
              <div className="d-flex flex-row align-items-center justify-content-center">
                <Image src={ChapterTwoImg4} alt="Chapitre 2" className="img-fluid" lazyLoadWrapperClassName="mx-3"/>
                <Image src={ChapterTwoImg5} alt="Chapitre 2" className="img-fluid" lazyLoadWrapperClassName="mx-3"/>
                <Image src={ChapterTwoImg6} alt="Chapitre 2" className="img-fluid" lazyLoadWrapperClassName="mx-3"/>
                <Image src={ChapterTwoImg7} alt="Chapitre 2" className="img-fluid" lazyLoadWrapperClassName="mx-3"/>
              </div>
        ...
        <div className="row">
          ...
          <div className="col-12 col-md-6 pl-lg-5">
            ...
            <div className="position-relative">
              ...
              <Image src={ChapterTwoImg11} alt="Chapitre 2" className="img-fluid" y={["200px", "-200px"]} figcaption="Jean-François Jolfre est membre du bureau de Paris Bike Polo. C’est un ancien membre du comité Bike Polo France. Ici, il joue sur un terrain à la frontière entre Pantin et Paris."/>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <div className="row">
          <div className="col-12 col-md-6 pr-lg-5 position-relative">
            ...
            <Image src={ChapterTwoImg12} alt="Chapitre 2" className="img-fluid" y={["200px", "-200px"]} figcaption="La règle du crease empêche un joueur non gardien de rester trop longtemps devant les buts. Elle a été à l’origine de vives réactions."/>
          </div>
          <div className="page-decoration page-decoration--is-full">
          ...
          <div className="col-12 col-md-6 pl-lg-5">
            <Image src={ChapterTwoImg13} alt="Chapitre 2" className="img-fluid" y={["200px", "-200px"]} figcaption="Sur le frigo de Paul Vergnaud, on trouve toute l’histoire ou presque du HardcourtBikePolo. La création graphique (stickers, affiches...) par les joueurs fait intimement partie de l’univers du sport, où son matériel est personnalisable avec une grande liberté."/>
          </div>
        </div>
      </div>
      <Spacer size="medium"/>
