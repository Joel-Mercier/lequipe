  ...
  const timeline = [
    {
      ...
      content: "L’ancêtre du Bike Polo, le Vélo-Polo, voit le jour en 1891, grâce à Richard J. Mercredy. Ce cycliste irlandais décide de remplacer le cheval par un vélo, afin de démocratiser la pratique de la discipline. Là aussi, les matchs se jouent sur gazon. Le premier, auquel participe l’équipe de Mercredy, a lieu la même année.",
    ...
    },
    {
      ...
      content: "Arrivé en 1900, le polo-vélo connaît un franc succès à Paris, vingt ans plus tard. En 1928, un premier championnat est organisé entre huit équipes. Quelques années plus tard, la discipline s’exporte hors de la capitale et séduit à l’échelle nationale, jusqu'à être définie pour la première fois dans l'édition 1932 du dictionnaire Larousse.",
    ...
    },
    {
      ...
      content: "A Seattle, le bike-polo passe du gazon au bitume. Profitant du développement des fixies, les livreurs et coursiers de la ville vont adapter le jeu à leur environnement en créant un cadre unique à cette pratique. C’est cette formule qui est aujourd’hui une des plus pratiquée dans le monde.",
    ...
    },
    {
      ...
      content: "Il s’agit des Axles of Evil, basé à Portland, une ville de l’Oregon, aux Etats-Unis. Ce sont eux qui ont commencer à cadrer la pratique du sport en imposant les premières règles, comme la taille de la surface de jeu, la balle utilisée ou les conditions pour marquer un but.",
    ...
    },
    {
      ...
      content: "Le Hardcourt Bike Polo prend une dimension internationale à partir de 2008 lors du CMWC, le championnat du monde des coursiers. Le tournoi se déroule à Toronto et réunit des équipes nord-américaines et européennes. Le premier championnat du monde dédié au Hardcourt Bike Polo s’officialise l’année suivante à Philadelphie.",
