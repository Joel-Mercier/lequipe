...
const players = [
  ...
  },
  {
    ...
    description: "Paul fait partie des pionniers de ce sport en France. Il en tombe amoureux pendant ses études de management. Il est un des joueurs qui permettra au bike-polo de prendre son élan au niveau national avec l’organisation du premier championnat de France à Toulouse en 2012. Depuis, vélo et polo n’ont cessé de rythmer sa vie quotidienne, bien que l’arrivée de son fils ait freiné son engagement purement sportif.",
